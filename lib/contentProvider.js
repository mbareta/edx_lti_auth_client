const deliverableContentTree = {
  businessplan: {
    ...
    <div style="border: 1px solid #e3e3e3">
      <p style="margin: 11px;">Tool features to note:</p>

      <p style="margin: 11px;"><b>View in course.</b> If you get stuck or need help while writing, you can find relevant course content by clicking the “View in course” link to the left of the Save button.</p>

      <p style="margin: 11px;"><b>Saving.</b> You can edit directly here or in the course itself. Any changes you make will be saved in both places.</p>

      <p style="margin: 11px;"><b>Downloading.</b> To download go to the “Preview Mode” link in the top right corner of the Workspace. This will be especially useful to you if you want to save a copy to use outside of the course or further refine your work using your own word processing software.</p>
    </div>
    <br>
    <div class="tip">
      <div class="tip-content">
      ...
      executivesummary: {
        ...
        <div class="subdeliverable tip">
          <div class="tip-content">
            ...
            You’ll want to write this part of your business plan last since it summarizes your plan. If you haven't completed your plan yet, you may want to come back to this section. Also, remember you can always access the entire Business Plan tool through the Workspace.
          </div>
        </div>
        `,
        activities: {
          venturedescription: {
            ...
            description: `
            <ul style="margin-left: 2%; margin-bottom: 16px;">
      ...
      productplan: {
        ...
        activities: {
          ...
          productlimitations: {
            ...
            description: '<ul style="margin-left: 2%; margin-bottom: 16px;"><li>What are the inherent product/service limitations, if any? Include perishability, limited shelf life, installation needs, legal restrictions, staff availability, or other relevant limitations.</li></ul>'
          },
...
`,
        ...
        activities: {
          businessstatement: {
            ...
            description: `What’s your business concept? Describe your business in a paragraph. Make sure to answer the following questions:
              <ul style="margin-left: 7.5%; margin-right: 8%; margin-bottom: 16px;">
          ...
          tweetablebusiness: {
            ...
            <div class="activity tip">
              <div class="tip-content">
                ...
                Use this <a href="http://http://www.twitter-character-counter.com/">Character Counter</a> to help you know how many characters you have left when composing your pitch.
              </div>
            </div>
            <br>
            <div class="after-tip-content">
          ...
          mystory: {
            title: 'Company Story',
            description: `
            As Craig Wortmann notes in his <a href="http://https://www.youtube.com/watch?v=E0r_9FZg31M">Kauffman Founders School series on Entrepreneurial Selling</a>, stories help provide context and connect your customers to the emotion(s) surrounding your product/service. Rather than citing the facts, how will you tell a compelling story that makes people feel something about your company?
            <br><br>
            To think about your company’s story, reflect on the following:
            <ul style="margin-left: 7.5%; margin-right: 8%;">
            ...
            <p style="margin-top: 16px; margin-left: 6%; margin-right: 8%;">Start working on the stories that will bring your business to life, below. Once you have multiple stories, you might consider organizing them into a <a href="http://https://www.youtube.com/watch?v=gtYl2uE62i4">story matrix</a></p>.
            `
          }
        }
      }
  ...
  financialforecast: {
    ...
    <b>Commit</b>
    <a href="http://alpha.fasttrac.org/courses/course-v1:Kauffman+nv+nv/courseware/84a9d56620d04b9da1efa239976ecdf4/036b16454ba047fb9ace91eeeec0123e/">Activity 1: Sales Projections and Assumptions</a>
    <a>Activity 2: Startup Costs Projections and Assumptions <LINK></a>
    <a>Activity 3: Cost of Goods Sold Projections and Assumptions <LINK></a>
    <a>Activity 4: Operating Expenses Projections and Assumptions <LINK></a>
    <a>Activity 5: Projecting Net Income <LINK></a>

    <b>Refine</b>
    <a>Activity 6: Cash Flow Projections <LINK></a>
    `,
    activitiesCount: 0,
    subDeliverables: {
      financialforecastdefault: {
        ...
        <br>
        <a>FastTrac Financial Model template Excel Workbook (.xlsx)</a><br>
        <a>Run KC Example Financial Model Excel Workbook (.xlsx)</a><br>
        <br>
        <b>If you have an older version of Microsoft Excel:</b><br>
        <br>
        <a>FastTrac Financial Model template Excel Workbook (1997-2004) (.xls)</a><br>
        <a>Run KC Example Financial Model Excel Workbook (1997-2004) (.xls)</a><br>
        <br>
