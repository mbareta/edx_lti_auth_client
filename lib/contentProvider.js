        ...
        activities: {
          venturedescription: {
            ...
            <ul style="margin-left: 2%; margin-bottom: 16px;">
              <li>What business is your venture in, and what is the current stage of development? Current stage of development may be startup, initial operation, expansion, rapid growth, or stable operation.
              <li>Briefly describe your business model. What is unique about the product/service, and what proprietary rights does the business have?
            </ul>
            `
          },
    ...
    subDeliverables: {
      businessmodelcanvasdefault: {
        activities: {
          ...
          differentiators: {
            title: 'Differentiating Activities',
