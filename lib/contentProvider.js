      ...
      pitchdeckdefault: {
        activities: {
          ...
          elevatorpitch: {
            ...
            <br>
            <div class="after-tip-content activity-instruction">
          ...
          mystory: {
            ...
            <p style="margin-top: 16px; margin-left: 6%; margin-right: 8%;">Start working on the stories that will bring your business to life, below. Once you have multiple stories, you might consider organizing them into a <a href="https://www.youtube.com/watch?v=gtYl2uE62i4">story matrix</a></p>.
            `
          }
        }
      }
