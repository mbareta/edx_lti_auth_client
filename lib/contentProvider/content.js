...
`
  ...
  businessmodelcanvas: {
    ...
    <div class="tip">
      <p>
        BMC content is designed to be concise and direct. That’s why we give you small boxes! You should use these sizes to guide your thinking.

        If you feel you need more space, that’s OK too- we encourage you to expand to the free text spaces. However, this content will not be displayed in the table view.

        You have flexibility in how you complete this table. We offer a few formatting options, such as bulleted lists and bolded text.

        If this is helpful, we encourage you to utilize formatting. However, keep in mind these features take up more space than plain text. You can always make more space for yourself by removing special formatting.
      </p>
    </div>
